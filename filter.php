...
<a href="inner_page.php?uid=<?php echo $collection_girl_item['id']; ?>"><img src="<?php echo 'assets/products/'.$collection_girl_item['image'];?>"></a>
  ...
  <div class="collection_text text-center mt-2">
    ...
    <h5 class="text-danger"><b><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $collection_girl_item['price'];?></b>
    <strike class="text-secondary"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $collection_girl_item['discont'];?></strike></h5>
  </div>
    </div>
</div>
  <?php
